    ...
    @section('page')
        <main class="bg-main h-screen relative font-ubuntu flex items-center justify-start">
            ...
            <div class="relative z-10 text-slate-100 pt-20 px-6 space-y-4">
                <h2 class="text-lg font-semibold uppercase">Selamat datang di Noken Soft</h2>
                <h1 class="text-5xl font-bold uppercase lg:text-7xl">Konsultan IT <br class="hidden md:block"> di Jayapura, Papua.
                </h1>
                <p class="text-md font-medium text-base md:pr-80 ">Pembuatan dan pengembangan aplikasi perkantoran, sistem informasi, dan jaringan komputer. <br class="hidden lg:block">
                    Klien kami terdiri dari pemerintahan tingkat kabupaten dan provinsi.</p>
                <button
                    class="transition duration-300 bg-slate-100 text-sky-800 py-2 px-4 rounded-xl font-bold text-md uppercase hover:bg-sky-800 hover:text-slate-100">Mulai</button>
            </div>
        </main>
