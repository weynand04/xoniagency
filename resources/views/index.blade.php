    ...
    @section('page')
        ...
        <section class="bg-white font-ubuntu">
            <div class="px-6 pt-20 pb-24 space-y-10 md:px-24">
                <div class="text-center text-gray-900 space-y-4">
                    <h2 class="text-4xl font-bold uppercase">We Are Creative Agency</h2>
                ...
                <div class="flex justify-center">
                    <div class="bg-white rounded-lg text-center grid grid-cols-1 gap-y-10 md:grid-cols-3 md:gap-x-6 ">
                        <div class="space-y-4 border border-gray-900/50 p-6">
                            ...
                            <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">CREATIVE WORKS
                            </h3>
                        ...
                        <div class="space-y-4 border border-gray-900/50 p-6">
                            ...
                            <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">BUSINESS PROGRESS
                            </h3>
                            <p class="mb-3 font-normal text-gray-900 opacity-60">curabitur ullamcorper ultricies nisi. Nam
                                eget dui.
                                Etiam
                        ...
                        <div class="space-y-4 border border-gray-900/50 p-6">
                            ...
                            <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">EASY CUSTOMIZE
        ...
        <section class="bg-slate-200 font-ubuntu">
            <div class="py-20 px-4 grid grid-cols-1 gap-y-8 md:grid-cols-2 md:space-x-4 lg:px-20">
                ...
                <div class="space-y-6 text-gray-900">
                    <h2 class="text-5xl font-medium">WE HELP BRANDS TO CONNECT AND GROW ON LARGE</h2>
        ...
        <section class="bg-white font-ubuntu">
            <div class="py-20 px-6 grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-4 lg:px-20">
                <div class="space-y-6">
                    <h2 class="text-4xl font-semibold uppercase md:text-5xl">What We Offer</h2>
                ...
                <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-2 lg:gap-x-6">
                    <div class="space-y-4 border border-gray-900/50 p-6 text-center">
                        ...
                        <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">CREATIVE DESIGN
                    ...
                    <div class="space-y-4 border border-gray-900/50 p-6 text-center">
                        ...
                        <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">MARKETING</h3>
                        <p class="mb-3 font-normal text-gray-900 opacity-60">curabitur ullamcorper ultricies nisi. Nam eget
                            dui. Etiam rhoncus.</p>
                    </div>
                    ...
                    <div class="space-y-4 border border-gray-900/50 p-6 text-center">
                        ...
                        <h3 class="mb-2 text-xl font-semibold tracking-tight text-gray-900">PROGRAMMING
            ...
            <div class="relative z-10 flex items-center justify-center h-full lg:h-auto">
                <div class="text-center max-w-7xl px-4 lg:px-8 lg:py-16">
                    <div class="mt-8 mb-8 grid grid-cols-1 gap-14 lg:grid-cols-4 lg:grid-rows-1 lg:gap-20">
                        <div class="space-y-2">
                            <h2 class="text-6xl text-slate-100 font-semibold counter" data-target="13"></h2>
                            <p class="text-slate-100 uppercase font-semibold whitespace-nowrap">Business Years</p>
                        </div>
                        <div class="space-y-2">
                            <h2 class="text-6xl text-slate-100 font-semibold counter" data-target="6213">0</h2>
                            <p class="text-slate-100 uppercase font-semibold whitespace-nowrap">Worldwide Clients</p>
                        </div>
                        <div class="space-y-2">
                            <h2 class="text-6xl text-slate-100 font-semibold counter" data-target="55">0</h2>
                            <p class="text-slate-100 uppercase font-semibold whitespace-nowrap">Our Team</p>
                        </div>
                        <div class="space-y-2">
                            <h2 class="text-6xl text-slate-100 font-semibold counter" data-target="344">0</h2>
        ...
        <section class="bg-white font-ubuntu">
            <div class="py-20 px-6 space-y-6 lg:px-20">
                <div class="text-center space-y-6">
                    <h2 class="text-4xl font-bold md:text-5xl text-gray-900">MEET OUR TEAM</h2>
                ...
                <div class="grid grid-cols-1 text-center gap-y-6 lg:grid-cols-4 lg:gap-x-4">
                    <div class="bg-white border border-gray-900/50 rounded-lg shadow">
                        ...
                        <div class="p-5">
                            <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">CRISTINA RENALDO
                            </h3>
                    ...
                    <div class="bg-white border border-gray-900/50 rounded-lg shadow">
                        ...
                        <div class="p-5">
                            <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">SMITH DENI
                            </h3>
                            <p class="mb-3 font-normal text-gray-700">Lorem Ipsum has been the industry's standard dummy
                            </p>
                        </div>
                    ...
                    <div class="bg-white border border-gray-900/50 rounded-lg shadow">
                        ...
                        <div class="p-5">
                            <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">AMMY GRILL
                            </h3>
                            <p class="mb-3 font-normal text-gray-700">Lorem Ipsum has been the industry's standard dummy
                            </p>
                        </div>
                    ...
                    <div class="bg-white border border-gray-900/50 rounded-lg shadow">
                        ...
                        <div class="p-5">
                            <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">KELLY JENNER
                            </h3>
                            <p class="mb-3 font-normal text-gray-700">Lorem Ipsum has been the industry's standard dummy
                            </p>
                        </div>
        ...
        <section class="bg-slate-200 font-ubuntu">
            <div class="py-20 px-6 space-y-6 lg:px-20">
                <div class="text-center space-y-4">
                    <h2 class="text-4xl font-bold text-gray-900 md:text-5xl">WE PROVIDE THE BEST OFFERS
                    </h2>
                ...
                <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:gap-x-10">
                    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-500">Standard plan</h3>
        ...
        <section class="bg-white font-ubuntu">
            <div class="py-20 px-6 space-y-8 md:px-20">
                <div class="text-center">
                    <h2 class="text-4xl text-gray-900 font-bold md:text-5xl">WHAT OUR CLIENT SAY
                    </h2>
                </div>
